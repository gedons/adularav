		...
		<div class="main-header">
			...
			<div class="sidebar">
				...
				<div class="main-panel h-100">
					<div class="content">
						<div class="container-fluid">
							<h4 class="page-title">Jumbotrons</h4>
							@if (session('success'))
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <a href="{{route('jumbotronCreate')}}" class="btn btn-link float-right">New Jumbotron </a>
                                        </div>
                                        <div class="card-body">
                                                ...
                                                <table class="table table-head-bg-primary table-striped table-hover">
                                                    ...
                                                    <tbody>
                                                        @foreach($jumbotrons as $jumbotron)
                                                            <tr>
                                                                <td>{{ $loop->index + 1 }}</td>
                                                                <td><img src="{{ $jumbotron->url }}" alt="jumbotron Image" style="max-width: 100px; height: 60px;"></td>															
                                                                <td>{{ $jumbotron->created_at->diffForHumans(); }}</td>
                                                                <td  class="td-actions">
