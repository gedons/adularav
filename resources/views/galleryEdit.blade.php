                                    ...
                                    <form method="POST" action="{{ route('gallery.update', $gallery->id) }}" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text"  value="{{ $gallery->gallerytext }}"  class="form-control  @error('gallerytext') is-invalid @enderror" name="gallerytext" value="{{ old('gallerytext') }}" id="gallerytext" required autocomplete="gallerytext" autofocus placeholder="Enter Image Title">
                                            ...
                                            <div class="form-group">
                                                ...
                                                @if ($gallery->url)
                                                    <img src="{{ $gallery->url }}" alt="gallery Image" class="mt-2" style="max-width: 200px;">
                                                @endif
                                                @error('image')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
