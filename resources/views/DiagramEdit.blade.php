				...
				<div class="content flex-grow-1">
					<div class="container-fluid">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="card">
                                    <form method="POST" action="{{ route('diagram.update', $diagram->id) }}" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleFormControlFile1">Diagram Image</label>
                                                <input type="file" class="form-control-file @error('image') is-invalid @enderror" name="image" id="exampleFormControlFile1">
                                                @if ($diagram->url)
                                                    <img src="{{ $diagram->url }}" alt="Diagram Image" class="mt-2" style="max-width: 200px;">
                                                @endif
                                                @error('image')
