		...
		<div class="main-header">
			...
			<div class="sidebar">
				...
				<div class="main-panel h-100">
					<div class="content">
						<div class="container-fluid">
							<h4 class="page-title">5D Diagram</h4>
							@if (session('success'))
								...
								<div class="col-md-12">
									<div class="card">
										<div class="card-header">
											<a href="{{route('diagramCreate')}}" class="btn btn-link float-right">Create New Diagram </a>
										</div>
										<div class="card-body">
												...
												<table class="table table-head-bg-primary table-striped table-hover">
                                                    ...
                                                    <tbody>
														@foreach($diagrams as $diagram)
															<tr>
																<td>{{ $loop->index + 1 }}</td>
																<td><img src="{{ $diagram->url }}" alt="diagram Image" style="max-width: 100px; height: 60px;"></td>
																<td>{{ $diagram->created_at->diffForHumans(); }}</td>
																<td>
																	<div class="form-button-action">
																		<a href="{{ route('diagram.edit', $diagram->id) }}" data-toggle="tooltip" title="Edit Diagram" class="btn btn-link <btn-simple-primary">
																			<i class="la la-edit"></i>
																		</a>
																		<form action="{{ route('diagram.destroy', $diagram->id) }}" method="POST" style="display: inline;">
																			@csrf
																			@method('DELETE')
																			<button type="submit" data-toggle="tooltip" title="Remove" onclick="return confirm('Are you sure you want to delete this diagram?')" class="btn btn-link btn-simple-danger">
