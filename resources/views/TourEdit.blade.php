		...
		<div class="main-header">
            ...
            <div class="main-panel  d-flex flex-column">
				<div class="content flex-grow-1">
					<div class="container-fluid">
						<h4 class="page-title">Video Tour</h4>
						<div class="row">
							<div class="col-md-12">
								<div class="card">
                                    <form method="POST" action="{{ route('tour.update', $tour->id) }}" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="name">Video Time Duration:</label>
                                                <input type="text" value="{{ $tour->title }}" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title') }}" id="title" required autocomplete="title" autofocus placeholder="Enter Video Time">
                                                @error('title')
                                            ...
                                            <div class="form-group">
                                                <label for="exampleFormControlFile1">Tour Video: </label>
                                                <input type="file" class="form-control-file @error('video') is-invalid @enderror" name="video" id="exampleFormControlFile1" required>
                                                <small id="nameHelp" class="form-text text-muted  mb-3">The video should be in an mp4 format.</small>
                                                @if ($tour->url)
                                                    <video width="240" height="120" controls>
                                                        <source src="{{ asset( $tour->url) }}" type="video/mp4">
