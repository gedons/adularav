                                    ...
                                    <form method="POST" action="{{ route('slider.store') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('headertext') is-invalid @enderror" name="headertext" value="{{ old('headertext') }}" id="headertext" required autocomplete="headertext" autofocus placeholder="Enter Slider Title">
                                            ...
                                            @enderror
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control @error('bodytext') is-invalid @enderror" name="bodytext" value="{{ old('bodytext') }}" id="bodytext" required autocomplete="bodytext" autofocus placeholder="Enter Slider Body">
                                                	<small id="nameHelp" class="form-text text-muted">The body of the slider.</small>
                                                    @error('bodytext')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
