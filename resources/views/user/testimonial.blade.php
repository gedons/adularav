...
<section class="bg-parallax bg-dark-overlay-4 py-5 py-md-8" style="background:url(assets/images/bg/09.jpg) no-repeat center center; background-size:cover;">
	...
	<div class="container">
		<div class="row d-flex justify-content-lg-between">
			<!-- Inner intro title -->
			<div class="col-lg-7">
				<h1 class="display-5 text-white-stroke">Testimonials <span class="text-white-stroke text-primary-shadow"></span></h1>
				<h5 class="text-white">
					<nav class="d-flex">
			...
			<div class="col-md-6 grid-item">
				<div class="bg-light p-4 p-md-5">
					...
					<div class="d-flex mb-4">
						<div class="avatar">
							<img class="avatar-img rounded-circle" src="assets/images/avatar/01.jpg" alt="author image">
						</div>
					...
					<!-- Testimonial text -->
					<p class="lead">A nice touch of creativity, easy to use, especially bootstrap 5. I love this, good work team !</p>
					<!-- Footer -->
