		...
		<div class="container">
			...
			<div class="collapse navbar-collapse " id="navbarCollapse">
				<ul class="navbar-nav navbar-nav-scroll navbar-nav-scroll mx-auto">
					...
					<li class="nav-item">	<a class="nav-link" href="index.html">Event Calendar</a></li>
			...
			<div class="nav flex-nowrap align-items-center">				
				...
				<div class="nav-item d-none d-xl-block">
					<a href="#" class="btn btn-sm btn-primary mb-0 mx-2">Get Quote!</a>
				</div>
			</div>
			<!-- Nav right END -->
		</div>
		...
		<div class="row d-flex justify-content-lg-between align-items-center">
			...
			<div class="col-lg-5">
				...
				<div class="mb-n6 ms-3 position-relative z-index-9">
					...
					<h2 class="display-4 text-dark-stroke text-primary-shadow">2005</h2>
				</div>
				<!-- Image -->
				<div class="reveal-item bg-light rounded" data-aos="reveal-item">
					...
					<img class="w-100" src="assets/images/about/06.jpg" alt="Portfolio image">
				</div>
				<!-- Label -->
				<span class="font-alt fw-normal display-8 bg-primary text-white float-end d-inline-block mt-n5 me-lg-n5 px-3 rotate-10">Passion, dedication & a lot of coffee 🤘</span>
			</div>

			<!-- About Right -->
			<div class="col-lg-6 mt-5 mt-lg-0 mt-xl-5">
				<!-- Title -->
				<span class="font-alt fw-normal display-8 d-block mb-3">We are creating smart websites.</span>
				<h3 class="mb-5">A Full package Digital Creative Agency Specializing in: Video Production, Web Design & Branding.</h3>
				<!-- Features -->
				<div class="row">
					<div class="col-sm-6 mb-4">
						<i class="display-6 text-primary bi bi-bullseye"></i>
						<h5 class="my-3">Our primary goal</h5>
						<p>Smart use of data & technology for the automation of your business.</p>
					</div>
					<div class="col-sm-6 mb-4">
						<i class="display-6 text-primary bi bi-bookmark-star"></i>
						<h5 class="my-3">20+ year experience</h5>
						<p>The right mix of resources for achieving your online goals.</p>
					</div>
				</div>
				<!-- Progress bar -->
				<div class="overflow-hidden mt-3">
					...
					<div class="progress progress-lg progress-percent-bg">
						<div class="progress-bar progress-bar-striped progress-bar-animated bg-primary aos" data-aos="slide-right" data-aos-delay="200" data-aos-duration="1000" data-aos-easing="ease-in-out" role="progressbar" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100" style="width:95%">
		...
		<div class="row">
			<div class="col-12">
				<div class="tiny-slider dots-bordered mb-5">
					<div class="tiny-slider-inner" data-autoplay="false" data-arrow="false" data-dots="true" data-items-xl="4" data-items-lg="4" data-items-md="3" data-items-sm="2" data-items-xs="1">
						<!-- Card item START -->
						<div class="item">
							<a href="#" class="card card-metro">
								...
								<div class="card-img-overlay d-flex flex-column">
									<div class="mt-auto card-text">
										<h5 class="text-white">Jessica Mores</h5>
						...
						<div class="item">
							<a href="#" class="card card-metro">
								...
								<div class="card-img-overlay d-flex flex-column">
									<div class="mt-auto card-text">
										<h5 class="text-white">Allen Maxwell</h5>
										<p class="small text-white mb-0">Software Developer</p>
									</div>
								</div>						
							</a>
						</div>
						...
						<div class="item">
							<a href="#" class="card card-metro">
								...
								<div class="card-img-overlay d-flex flex-column">
									<div class="mt-auto card-text">
										<h5 class="text-white">Emma Watson</h5>
										<p class="small text-white mb-0 text-truncate">Human Resource</p>
									</div>
								</div>						
							</a>
						</div>
						...
						<div class="item">
							<a href="#" class="card card-metro">
								...
								<div class="card-img-overlay d-flex flex-column">
									<div class="mt-auto card-text">
										<h5 class="text-white">Alexa Smith</h5>
										<p class="small text-white mb-0 text-truncate">Project Manager</p>
									</div>
								</div>
							</a>
						</div>
						...
						<div class="item">
							<a href="#" class="card card-metro">
								<!-- Card Image -->
								<div class="card-image">
									<img src="assets/images/team/05.jpg" alt="card image">
								</div>
								<!-- Card Overlay -->
								<div class="card-img-overlay d-flex flex-column">
									<div class="mt-auto card-text">
										<h5 class="text-white">Peter White</h5>
										<p class="small text-white mb-0 text-truncate">Graphics Designer</p>
									</div>
								</div>
							</a>
						</div>
						...
						<div class="item">
							<a href="#" class="card card-metro">
								<!-- Card Image -->
								<div class="card-image">
									<img src="assets/images/team/06.jpg" alt="card image">
								</div>
								<!-- Card Overlay -->
								<div class="card-img-overlay d-flex flex-column">
									<div class="mt-auto card-text">
										<h5 class="text-white">Amanda Reed</h5>
										<p class="small text-white mb-0">UI/UX Designer</p>
									</div>
								</div>
							</a>
						</div>
						...
						<div class="item">
							<a href="#" class="card card-metro">
								<!-- Card Image -->
								<div class="card-image">
									<img src="assets/images/team/07.jpg" alt="card image">
								</div>
								<!-- Card Overlay -->
								<div class="card-img-overlay d-flex flex-column">
									<div class="mt-auto card-text">
										<h5 class="text-white">Louis Crawford</h5>
										<p class="small text-white mb-0">Content Writer</p>
									</div>
								</div>
							</a>
						</div>
						...
						<div class="item">
							<a href="#" class="card card-metro">
								<!-- Card Image -->
								<div class="card-image">
									<img src="assets/images/team/08.jpg" alt="card image">
								</div>
								<!-- Card Overlay -->
								<div class="card-img-overlay d-flex flex-column">
									<div class="mt-auto card-text">
										<h5 class="text-white">Lori Stevens</h5>
										<p class="small text-white mb-0">Manager</p>
									</div>
								</div>
							</a>
						</div>
			...
			<div class="col-md-6 col-lg-3 mb-5">
				...
				<div class="d-flex me-auto">
					...
					<div class="list-group-inline list-unstyled text-primary-hover">
						...
						<a href="#" class="list-group-item text-white bg-transparent">Dr</a>
					</div>
				</div>
			</div>
