...
<head>
	<title>Book Now - Aduvie Events Center</title>
	<!-- Meta Tags -->
	<meta charset="utf-8">
...
<section class="bg-parallax bg-dark-overlay-4 py-5 py-md-8" style="background:url(assets/images/pagebanner.jpg) no-repeat center center; background-size:cover;">
	...
	<div class="container">
		<div class="row d-flex justify-content-lg-between">
			<!-- Inner intro title -->
			<div class="col-lg-7">
				<h1 class="display-5 text-white-stroke">Book <span class="text-white-stroke text-primary-shadow"> Event</span></h1>
				<h5 class="text-white">
					<nav class="d-flex">
					<ol class="breadcrumb breadcrumb-dark">
						<li class="breadcrumb-item text-white"><a href="index.html">Aduvie Events Center</a></li>
						<li class="breadcrumb-item text-white">Book</li>
					</ol>
				</nav>
				</h5>
			</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-7">
                ...
                @endif
				<!-- Form START -->
				<form class="contact-form form-line" id="contact-form"  method="POST" action="{{ route('booking.create') }}">
                    @csrf
					<!-- Main form -->
					<div class="row">
						<div class="col-md-6">
                            ...
                            <div class="form-group">
                                <input type="text" placeholder="First Name" class="form-control @error('firstName') is-invalid @enderror" id="firstName" name="firstName" value="{{ old('firstName') }}">
                                @error('firstName')
                        ...
                        <div class="col-md-6">
							<!-- name -->
                            <div class="form-group">
                                <input type="text" placeholder="Last Name" class="form-control @error('lastName') is-invalid @enderror" id="lastName" name="lastName" value="{{ old('lastName') }}">
                                @error('lastName')
                                  <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                  </span>
                        ...
                        <div class="col-md-12">
							<!-- Message -->
							<div class="mb-3 position-relative">
                                <textarea placeholder="Description" class="form-control  @error('description') is-invalid @enderror" id="description" name="description" rows="5">{{ old('description') }}</textarea>
                                @error('description')
                                  <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                  </span>
						...
						<!-- submit button -->
						<div class="col-md-12 text-start"><button class="btn btn-primary btn-line" type="submit">Book</button></div>
					</div>
				</form>
				<!-- Form END -->
			</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      var calendar = new FullCalendar.Calendar(calendarEl, {
        initialView: 'dayGridMonth', // Adjust initial calendar view
