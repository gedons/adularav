                                    ...
                                    <form method="POST" action="{{ route('home_slider.store') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title') }}" id="title" required autocomplete="title" autofocus placeholder="Enter Slider Title">
                                            ...
                                            @enderror
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"  class="form-control @error('description') is-invalid @enderror" name="description" value="{{ old('description') }}" id="description" required autocomplete="description" autofocus placeholder="Enter Slider Description">
