                                    ...
                                    <form method="POST" action="{{ route('tour.store') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="title">Video Time (minutes):</label>
                                                <input type="number" class="form-control @error('title') is-invalid @enderror" id="title" name="title" required>
                                                @error('title')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="form-control-file @error('video') is-invalid @enderror" name="video" id="video">
                                                <small id="nameHelp" class="form-text text-muted">The video should be in an mp4 format.</small>
                                                @error('video')
                                                    <span class="invalid-feedback" role="alert">
                                                     <strong>{{ $message }}</strong>
                                                    </span>
