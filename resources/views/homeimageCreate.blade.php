						...
						<div class="row">
							<div class="col-md-12">
								<div class="card">
                                    ...
                                    <form method="POST" action="{{ route('home_image.store') }}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label for="name">Header Text</label>
                                                <input type="text" class="form-control @error('headertext') is-invalid @enderror" name="headertext" value="{{ old('headertext') }}" id="headertext" required autocomplete="headertext" autofocus placeholder="Enter Image Title">
                                            ...
                                            @enderror
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control @error('bodytext') is-invalid @enderror" name="bodytext" value="{{ old('bodytext') }}" id="bodytext" required autocomplete="bodytext" autofocus placeholder="Enter Image Body">
