                                    ...
                                    <form method="POST" action="{{ route('gallery.store') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('gallerytext') is-invalid @enderror" name="gallerytext" value="{{ old('gallerytext') }}" id="gallerytext" required autocomplete="gallerytext" autofocus placeholder="Enter Image Title">
