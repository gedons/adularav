								...
								<div class="col-md-12">
									<div class="card">
										<div class="card-header">
											<a href="{{route('sliderCreate')}}" class="btn btn-link float-right">Create New Slider </a>
										</div>
										<div class="card-body">
												...
												<table class="table table-head-bg-primary table-striped table-hover">
                                                    ...
                                                    <tbody>
														@foreach($sliders as $slider)
															<tr>
																<td>{{ $loop->index + 1 }}</td>
																<td><img src="{{ $slider->url }}" alt="Slider Image" style="max-width: 100px; height: 60px;"></td>
																<td>{{ $slider->headertext }}</td>
																<td>{{ $slider->bodytext }}</td>
