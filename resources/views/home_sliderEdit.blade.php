	...
	<div class="wrapper">
		<div class="main-header">
            ...
            <div class="main-panel">
				<div class="content">
					<div class="container-fluid">
						<h4 class="page-title">Home Hall Sliders</h4>
						<div class="row">
							<div class="col-md-12">
								<div class="card">
                                    ...
                                    <form method="POST" action="{{ route('home_slider.update', $home_slider->id) }}" enctype="multipart/form-data">
                                        @csrf   
                                        @method('PUT')                                
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label for="name">Slider Title</label>
                                                <input type="text"  value="{{ $home_slider->title }}" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title') }}" id="title" required autocomplete="title" autofocus placeholder="Enter Slider Title">
                                                <small id="nameHelp" class="form-text text-muted">The title of the slider.</small>
                                                @error('title')
                                            ...
                                            <div class="form-group">
                                                ...
                                                @if ($home_slider->url)
                                                <img src="{{ $home_slider->url }}" alt="home_slider Image" class="mt-2" style="max-width: 200px;">
                                                @endif
                                                @error('image')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                            ...
                                            @enderror
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{ $home_slider->description }}" class="form-control @error('description') is-invalid @enderror" name="description" value="{{ old('description') }}" id="description" required autocomplete="description" autofocus placeholder="Enter Slider Description">
                                                	<small id="nameHelp" class="form-text text-muted">The description of the Slider.</small>
                                                    @error('description')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
